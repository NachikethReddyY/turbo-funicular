...
Start here for Nachiketh's A01 + A09 work.
...
```
Docs/
├── guides/           How-to (API testing, post-fix screenshots)
├── reports/          Submitted vulnerability reports
├── templates/        Course templates
├── scouting/         Week 0 scouting (team)
├── tracking/         Progress logs, fix checklists
└── archive/          Superseded A09 drafts, handoffs
```
...
```
Assets/Nachiketh/
├── a01/          A01 before-fix (you captured)
├── a01-after/    A01 post-fix ← see postfix guide
├── a09/          A09 before-fix (done)
└── a09-after/    A09 post-fix ← see postfix guide
```
