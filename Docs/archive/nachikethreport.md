...
> **This file has moved.** The canonical report is **[reports/nachiketh-report.md](reports/nachiketh-report.md)** (A01 → A09 flow, all A09 images embedded).  
> Template: [vulnerability-report-template.md](vulnerability-report-template.md) · Docs index: [README.md](README.md)
